...
print("we have loaded the basics")
...
print("we have loaded the libraries")
...
function writeDataCSV(name, matrix)
  ...
  CSV.write(path*"/out/"*string(name), dt)
end
...
function seleccionaOrderedClusters(name)
  ...
  @save path*"/out/$name.jld2" aux
  #@save path*"/out/matu$name.jld2" matu
  #return aux
end
